        ...
        <Card className="shadow-lg hover:shadow-xl transition-shadow duration-300">
          ...
          <CardContent className="pt-6">
            ...
            <p className="text-muted-foreground mb-6">
              StressCall uses advanced AI to analyze voice patterns, providing
              insights into your stress levels during calls or through on-demand
              checks.
            </p>
